...
ChatLogic::ChatLogic() {
  //// (DONE!)
  /// Decided to create an instance of chatbot on the stack
}

ChatLogic::~ChatLogic() {
  //// (DONE!)
  /// Since the chatbot is on stack
  /// The intentional bug is vanished.
}
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename) {
      ...
      if (type != tokens.end()) {
        ...
        if (idToken != tokens.end()) {
          ...
          if (type->second == "NODE") {
            ...
            /// Decided to use Unique Smart_ptr for node.
            auto newNode =
          ...
          if (type->second == "EDGE") {
            ...
            if (parentToken != tokens.end() && childToken != tokens.end()) {
              ...
              /// Since I've used Unique Smart_ptr for node.
  ...
  ChatBot stackBot("../images/chatbot.png");

  /// Update _chatBot handle
  SetChatbotHandle(&stackBot);

  /// Update chatlogic handle
